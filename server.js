...
function simulatePlinkoBall(rows) {
    ...
    if (rows === 8) {
        ...
        // НОВОЕ РАСПРЕДЕЛЕНИЕ: 95% на маленькие, 5% на большие
        // Позиции: 0(5.8x), 1(2.2x), 2(0.8x), 3(0.4x), 4(0.8x), 5(2.2x), 6(5.8x)
        probabilities = [0.025, 0.025, 0.2375, 0.475, 0.2375, 0.025, 0.025];
        
        // Проверка: 0.025 + 0.025 + 0.2375 + 0.475 + 0.2375 + 0.025 + 0.025 = 1.05 (округляем)
        // Корректируем чтобы сумма была 1
        probabilities = [0.0238, 0.0238, 0.2262, 0.4524, 0.2262, 0.0238, 0.0238];
    }
