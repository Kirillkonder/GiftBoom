...
async function startServer() {
    ...
    const rocketRoutes = require('./rocketRoutes')(rocketGame, db, users, transactions, rocketGames, rocketBets, updateCasinoBank, updateCasinoDemoBank, updateRTPStats, getUserDisplayName, broadcastRocketUpdate);
